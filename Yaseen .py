...
try:
        ...
        os.system('pip install futures==2 && python yaseen.py')
...
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     YASEEN KHAN Offcile
{50*"-"}'''
...
class crack_main():
        ...
        def crackmail(self,id):
                ...
                user=[]
                print(" [*] First Name Example Yaseen,Pathni")
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[FAISAL] %s / [OK-%Y] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
